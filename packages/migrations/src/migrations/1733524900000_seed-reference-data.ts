...
export async function up(pgm: MigrationBuilder): Promise<void> {
  ...
  const denialCodes = [
    {
      ...
      is_appealable: true,
      common_resolution: 'Obtain retroactive authorization or appeal with medical necessity documentation',
      prevention_tips: 'Implement pre-service authorization checks for all procedures requiring prior auth',
    },
    {
      code: 'CO-16',
    ...
    },
    {
      ...
      prevention_tips: 'Implement coding validation rules for modifier requirements',
    },
    {
      code: 'CO-50',
      ...
      is_appealable: true,
      common_resolution: 'Appeal with medical necessity documentation or obtain ABN for patient responsibility',
      prevention_tips: 'Review medical necessity criteria before service delivery',
    },
    {
      code: 'CO-22',
      ...
      is_appealable: true,
      common_resolution: 'Bill primary insurance first or provide COB documentation',
    ...
    },
    {
      ...
      is_appealable: true,
      common_resolution: 'Review bundling rules; appeal if services were truly distinct',
    ...
    },
    {
      ...
      prevention_tips: 'Verify patient cost-sharing requirements before service',
    },
    {
      code: 'CO-29',
      ...
      is_appealable: true,
      common_resolution: 'Appeal with documentation of timely filing or extenuating circumstances',
      prevention_tips: 'Monitor claim submission timelines and payer-specific filing deadlines',
    },
    {
      code: 'CO-18',
      category: 'DUPLICATE',
      ...
      is_appealable: true,
      common_resolution: 'Review claims history; if not duplicate, appeal with clarification',
    ...
    },
    {
      ...
      is_appealable: true,
      common_resolution: 'Verify coverage dates; appeal if service was within coverage period',
    ...
    },
    {
      ...
      is_appealable: true,
      common_resolution: 'Review policy coverage; appeal if service should be covered',
  ...
  for (const policy of policies) {
    ...
    const category = policy['denial_category'] ? `'${policy['denial_category']}'` : 'NULL';
  ...
  const codingRules = [
    {
      ...
      error_message: 'Modifier 25 is required when billing E/M service on same day as procedure',
      severity: 'warning',
    },
    {
      ...
      error_message: 'Use modifier 50 for bilateral procedures or bill with RT/LT modifiers',
      severity: 'warning',
    },
    {
      ...
      error_message: 'Screening colonoscopy (45378) requires Z12.11 diagnosis code',
      severity: 'error',
    },
    {
      ...
      error_message: 'Modifier 59 may be needed to bypass NCCI edits for distinct services',
      severity: 'info',
    },
    {
      rule_name: 'Invalid Diagnosis Z00.00',
      rule_type: 'diagnosis_validation',
      error_message: 'Z00.00 is too general and may not support medical necessity for most services',
      severity: 'warning',
    },
  ];
  ...
  for (const rule of codingRules) {
    ...
    const requiredModifier = rule.required_modifier ? `'${rule.required_modifier}'` : 'NULL';
    const diagnosisPattern = rule.required_diagnosis_pattern ? `'${rule.required_diagnosis_pattern}'` : 'NULL';
