...
1. **Enable GitHub Pages:**
   - Go to your repo: https://github.com/cavera/rcm/settings/pages
...
4. **Wait for deployment:**
   ...
   - Check progress: https://github.com/cavera/rcm/actions
...
navbar: {
  items: [
    ...
    {to: '/blog', label: 'Blog'},
    {
      href: 'https://github.com/cavera/rcm',
      label: 'GitHub',
    },
  ],
}
...
1. Check Actions tab: https://github.com/cavera/rcm/actions
